...
module ExtCore = {
  ...
  public module TokenIdentifier = {
    ...
    public func fromBlob(b : Blob, i : TokenIndex) : TokenIdentifier {
      ...
      // print pricipal to blob to array  result
      return fromBytes(Blob.toArray(b), i);
    };
    public func fromBytes(c : [Nat8], i : TokenIndex) : TokenIdentifier {
      let bytes : [Nat8] = Array.append(Array.append(tds, c), Binary.BigEndian.fromNat32(i));
      //var crc : [Nat8] = CRC32.crc32(bytes);
      //var temp: [Nat8] = Array.append(crc, bytes);
    ...
    public func decode(tid : TokenIdentifier) : TokenObj {
      ...
      let v : TokenObj = {
        ...
        index = Binary.BigEndian.toNat32(_token_index);
        canister = _canister;
